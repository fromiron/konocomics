...
| S6 | Slice 11 LCP 예산 | cold mobile 5회 중앙값 <2.5s | **REFINE** | 랜딩·추천 각각 <3.5s (`04` §8) | 이미지와 일본어 웹폰트가 많은 실제 제품 경로에서 2.5s는 과도하게 엄격하다는 2026-08-16 사용자 결정. 실제 browser-selected LCP·고정 throttle·cold 5회 중앙값 계약은 유지 |
