# Batch 003 chunk 02 independent non-Art review request
...
| `data/staging/catalog-expansion/batches/batch-003/research/chunk-02.md` | `7c59174ec97cc10922aabc09208f19e04e74ea6a852734cb9dbdf77ebdc5add5` |
| `data/staging/catalog-expansion/batches/batch-003/annotation-pass-a/chunk-02/factors.csv` | `fadb3aad99068ca027c887ad3f372b05272206d88e6dc4ef7dea79c16c1c452e` |
| `data/staging/catalog-expansion/batches/batch-003/annotation-pass-a/chunk-02/genres.csv` | `c403be06bdea6fb71a218b7faaaa549d302873f1ab85a9d5ff1de94788444459` |
| `data/staging/catalog-expansion/batches/batch-003/annotation-pass-a/chunk-02/themes.csv` | `2a4e92d21ec4cb05c889834cf42859cb837f5247e53f7f3924411ae53968b575` |
| `data/staging/catalog-expansion/batches/batch-003/annotation-pass-a/chunk-02/notes.md` | `5aea0caf4802bbe504aee15d169962b05e9050c6837b89c232825985f28fc99c` |
...
Canonical titles must not contain decorative `『` or `』` delimiters. The three
full-width exclamation marks in `BUTTER！！！` are part of the frozen canonical
title and must remain. Preserve all other frozen punctuation exactly; a source
punctuation difference is an alias or normalization observation, not a new Work.
...
7. Identity, safety, and representative-ISBN table for all 10 works with frozen
   ...
   URL. Explicitly inspect the Media Factory/KADOKAWA edition lead for
   `高杉さん家のおべんとう`, the original/new-edition relation for `もやしもん`,
   and the JDCN/print-ISBN lead for `きょうは会社休みます。`. Also inspect the
   sensitive-content leads for `乱と灰色の世界`, `刻刻`, and
   `きょうは会社休みます。`. Dark, violent, age-gap, or sexual content is not by
   itself adult-only status.
